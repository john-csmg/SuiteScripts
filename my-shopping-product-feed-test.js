...
var SCRIPT_PARAM_PROC_INTERNALID='custscriptcustscriptmyshoppingparameter1';
var XML_PARAM_INTERNALID='custscriptcustscriptmyshoppingparameter2';
var lastProcessedId = '';
var intID = '';
	...
	try {
		...
		if(items && items.length > 0)
		{
			...
			for (var i=0; i < items.length; i++) {
	    		...
	    		xml += '<name>'+ Name + '</name>' + '\n';
	    		xml += '<code>'+ SKU + '</code>' + '\n';
	    		xml += '<description>'+ shortdescrition + '</description>' + '\n';
	    		xml += '<product_url>'+ urlcomponent +'</product_url>' + '\n';
	    		xml += '<category>'+ Category + '</category>' + '\n';
	    		xml += '<image_url>'+ ImageURL +'</image_url>' + '\n';
	    		xml += '<shipping>'+ ShippingRate +'</shipping>' + '\n';
	    		xml += '<brand>'+ Manufacturer + '</brand>' + '\n';
			...
			if(done==1)
				...
				var filetype = 'XMLDOC';
				var folderid = '5352873'; //feeds folder

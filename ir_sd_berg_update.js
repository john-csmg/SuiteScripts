    ...
    function (record, log, search, runtime, email, file, _, moment, task, JSZIP, XLSX) {
        ...
        function updateProductStocks() {
            ...
            if (internalId !== '') {
                ...
                sendEmail('SD Berg Stock Update - Stock file not found', `Could not find the stock file. <br/>  Please try searching using Netsuite Global Search. <br/><br/> File: <b>${stockFileName}</b>`);
            }
        }
        ...
        function getCsvData(internalId) {
            ...
            if (csvContent.length > 15) {
                for (let i = 9; i < csvContent.length; i++) {
                    /*
                ...
                sendEmail('SD Berg Stock Update - Blank stock file', `File: <b>${stockFileName}</b> is empty. <br/> Please coordinate this with the supplier.`);
            }
